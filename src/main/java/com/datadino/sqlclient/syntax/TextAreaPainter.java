 ...
 * lines of text.
 * @author Slava Pestov
 * @version $Id: TextAreaPainter.java,v 1.4 2002/12/13 08:21:40 jbanes Exp $
 */
public class TextAreaPainter extends JComponent implements TabExpander
{
    ...
    public final void addPainterListener(PainterListener listener)
    {
    ...
    public final void fireInvalidateLineRangeEvent(int firstLine, int lastLine)
    {
        PainterListener listener;
        
        for(int i=0; i<listeners.size(); i++)
        {
            listener = (PainterListener)listeners.get(i);
            listener.invalidateLineRange(firstLine, lastLine);
        }
    }
    ...
    public void paint(Graphics gfx)
    {
            ...
            try
            {
                ...
                for(int line = firstInvalid; line <= lastInvalid; line++)
                {
                    ...
                    fireInvalidateLineRangeEvent(line, line);
                }
    ...
    protected void paintPlainLine(Graphics gfx, int line, Font defaultFont, Color defaultColor, int x, int y)
    {
        ...
        if(bracketHighlight && line == textArea.getBracketLine()) paintBracketHighlight(gfx, line, y - fm.getHeight());
    ...
    {
            if(line >= textArea.getSelectionStartLine() && line <= textArea.getSelectionEndLine()) paintLineHighlight(gfx,line,y);
    ...
    protected void paintBracketHighlight(Graphics gfx, int line, int y)
    {
        ...
        char bracket = textArea.getLineText(line).charAt(position);
        
        gfx.setColor(bracketHighlightColor);
        gfx.fillRect(x, y + fm.getLeading() + fm.getMaxDescent(), fm.charWidth(bracket) - 1, fm.getHeight() - 1);
        gfx.setColor(Color.white);
        gfx.drawString(bracket+"", x, textArea.lineToY(line+1));
    }
    ...
    protected void paintCaret(Graphics gfx, int line, int y)
    {
        if(textArea.isCaretVisible())
        {
            ...
            if(textArea.isOverwriteEnabled()) gfx.fillRect(caretX, y + height - 1, caretWidth,1);
