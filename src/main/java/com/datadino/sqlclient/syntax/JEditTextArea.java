 ...
 *
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java,v 1.8 2004/04/06 05:23:24 jbanes Exp $
 */
public class JEditTextArea extends JComponent
{
    ...
    /**
     * Adding components with this name to the text area will place
     * them left of the main text area. This is generally used for line
     * numbers.
     */
    public static String LEFT = "left";
    
    private UndoManager undoManager = new UndoManager();
    private LineNumberDisplay lineNumbers = new LineNumberDisplay(this);
    private static boolean enhanced = false;
    private AdjustHandler adjust = new AdjustHandler();
    ...
    public JEditTextArea(TextAreaDefaults defaults)
    {
            ...
            if(enhanced)
            {
                new MouseWheelAjustmentListener(this, vertical).addAdjustmentListener(adjust);
            }
            
            // Add some event listeners
            vertical.addAdjustmentListener(adjust);
            horizontal.addAdjustmentListener(adjust);
            painter.addComponentListener(new ComponentHandler());
            painter.addMouseListener(new MouseHandler());
            painter.addMouseMotionListener(new DragHandler());
            painter.addPainterListener(lineNumbers);
		...
		public void focusGained(FocusEvent evt)
                {
                    adjust.adjustmentValueChanged(new AdjustmentEvent(vertical, AdjustmentEvent.ADJUSTMENT_VALUE_CHANGED, AdjustmentEvent.TRACK, vertical.getValue()));
                }
...
//                                    .replace('\r','\n');
    ...
    class ScrollLayout implements LayoutManager
    {
            public void addLayoutComponent(String name, Component comp)
            {
                ...
                else if(name.equals(LEFT)) left = comp;
